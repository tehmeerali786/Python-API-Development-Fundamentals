...
class RecipeResource(Resource):
    ...
    def put(self, recipe_id):
        ...
        if current_user != recipe.user_id:
            return {'message' : 'Access is not denied'}, HTTPStatus.FORBIDDEN
    ...
    def patch(self, recipe_id):
        ...
        recipe.description = data.get('descritption') or recipe.description
        recipe.num_of_serving = data.get('num_of_serving') or recipe.num_of_serving
